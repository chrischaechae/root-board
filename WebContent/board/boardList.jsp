...
<body>
		...
		<tbody>
			<c:forEach var="board" items="${list}">
				<tr>
					...
					<td width="210" style="font-family: Gulim; font-size: 12px;"><a href="detail.do?seq=${board.seq}" style="text-decoration: none;">&nbsp;${board.title}</a></td>
	...
	<form action="list.do" method="post" onsubmit="return searchCheck()">
		<table width="500" align="center">
			<tr>
				...
				<input type="submit" id="search" value="검색" style="font-family: Gulim; font-size: 12px;">
				</td>
